...
int main(int argc, char* argv[]) {
    ...
    // Erroneous line produced by ChatGPT 
    printf("Before for loop, factor = undefined.\n");
    // Original line, not working due to the wrong scoping of the factor variable
    ...
    // Erroneous line produced by ChatGPT 
    printf("After for loop, factor = undefined.\n");
    // Original line, not working due to the wrong scoping of the factor variable
